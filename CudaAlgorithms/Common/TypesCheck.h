...
#define CHECK_SAME_LAYOUT2(my_t, cuda_t)                          \
    static_assert(std::is_standard_layout_v<my_t>);               \
    static_assert(std::is_standard_layout_v<cuda_t>);             \
