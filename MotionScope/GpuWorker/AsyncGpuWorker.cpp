...
namespace app::worker {
	AsyncGpuWorker::AsyncGpuWorker(std::unique_ptr<motion::MotionViewProcessor> processor)
	...
	void AsyncGpuWorker::AddJob(motion::IGpuJob::Ptr&& job) {
		{
